...
pub fn paint_altitude_by_time(
    ...
    let (moon_r, moon_g, moon_b) = (0.05, 0.3, 0.3);
    let sun_alt_theshold = degree_to_radian(-18.0);
    let bg = gdk::cairo::LinearGradient::new(0.0, 0.0, width, 0.0);
    ...
    for i in STEPS*PAST_HOUR..=STEPS*FUTU_HOUR {
        ...
        let offset = (i - STEPS*PAST_HOUR) as f64 / (STEPS*FUTU_HOUR - STEPS*PAST_HOUR + 1) as f64;
        bg.add_color_stop_rgb(offset, r, g, b);
    }
